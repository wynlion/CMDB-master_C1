...
class AllProjects(models.Model):
    ...
    status = models.CharField(choices=project_status, max_length=64, default='begin', verbose_name='项目状态')
    ...
    def __str__(self):
        return '<%s>  %s' % (self.get_project_type_display(), self.project_name)
